...
//
  ...
  // LCD Pins
        ...
        // SS // #define LCD_PINS_RS     30 // CS chip select /SS chip slave select
        // SS // #define LCD_PINS_ENABLE 29 // SID (MOSI)
        // SS // #define LCD_PINS_D4     17 // SCK (CLK) clock
  ...
  // SS // #define BTN_EN1               11
  // SS // #define BTN_EN2               10
  #define BTN_EN1               30
  #define BTN_EN2               29
  #if ENABLED(LCD_I2C_PANELOLU2)
    #if IS_MELZI
      #define BTN_ENC           29
      // SS // #define LCD_SDSS          30 // Panelolu2 SD card reader rather than the Melzi
